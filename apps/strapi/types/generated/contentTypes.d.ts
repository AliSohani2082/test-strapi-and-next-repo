...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    poster: Schema.Attribute.Media<"images" | "files"> &
      Schema.Attribute.Required
    publishedAt: Schema.Attribute.DateTime
    related_from: Schema.Attribute.Relation<
      "manyToMany",
      "api::article.article"
    >
    related_to: Schema.Attribute.Relation<"manyToMany", "api::article.article">
...
export interface ApiDoctorDoctor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    certifications: Schema.Attribute.Component<"utilities.text", true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true
        }
    ...
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> &
      Schema.Attribute.Private
    education: Schema.Attribute.Component<"utilities.text", true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true
        }
    ...
    fullEnglishName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Private
    ...
    publishedAt: Schema.Attribute.DateTime
    services: Schema.Attribute.Component<"utilities.text", true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true
        }
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    internalLinks: Schema.Attribute.Component<"utilities.link", true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true
        }
    ...
    publishedAt: Schema.Attribute.DateTime
    serviceLinks: Schema.Attribute.Component<"utilities.link", true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true
        }
      }>
    socialMediaLinks: Schema.Attribute.Component<"utilities.link", true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true
        }
    ...
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> &
      Schema.Attribute.Private
    workingHoursFriday: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true
        }
      }>
    workingHoursWeekdays: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true
        }
